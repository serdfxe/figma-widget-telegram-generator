...
export function Icon({ onEvent, icon, color, ...props }: IconProps) {
   const svgPaths = {
      ...
      <path d="M16 0.5H0V12.5H16V0.5Z" fill="${color}"/></mask><g mask="url(#mask0_139_4775)">
      ...
      </g></g><defs><clipPath id="clip0_139_4775"><rect width="16" height="13" fill="${color}"/></clipPath></defs>
      </svg>`,
